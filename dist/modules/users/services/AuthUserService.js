...
var AuthUserService = /** @class */ (function () {
    ...
    AuthUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, password_hash, passwordMatched, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Invalid email/password', 401);
                        }
                        password_hash = user.password_hash;
                        return [4 /*yield*/, bcryptjs_1.compare(password, password_hash)];
                    case 2:
